                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('register') }}" class="pt-4">
                                ...
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form--control" id="password_confirmation" type="password"
                                ...
                                <div class="btn-box">
                                    <div class="custom-control custom-checkbox mb-2 fs-15">
                                        ...
                                        <label class="custom-control-label custom--control-label lh-20"
                                            ...
                                            emails with exclusive deals, personal recommendations and learning tips!</label>
