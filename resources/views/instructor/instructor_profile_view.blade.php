@extends('instructor.insctuctor_dashboard')
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="{{ $profileData->photo ? asset("upload/instructor_images/{$profileData->photo}") : asset('upload/no_image.jpg') }}   "
                            ...
                            <form action="{{ route('instructor.profile.store') }}" method="post"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img id="showImage"
                                                src="{{ $profileData->photo ? asset("upload/instructor_images/{$profileData->photo}") : asset('upload/no_image.jpg') }}   "
